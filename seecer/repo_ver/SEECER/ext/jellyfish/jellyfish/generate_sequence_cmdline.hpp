...
#ifndef __GENERATE_SEQUENCE_CMDLINE_HPP__
#define __GENERATE_SEQUENCE_CMDLINE_HPP__
...
class generate_sequence_cmdline {
...
public:
  ...
  generate_sequence_cmdline(int argc, char* argv[]) :
    seed_arg(0), seed_given(false),
    mer_arg(), mer_given(false),
    output_arg("output"), output_given(false),
    fastq_flag(false),
...
#endif // __GENERATE_SEQUENCE_CMDLINE_HPP__"
